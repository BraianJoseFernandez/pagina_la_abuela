    ...
    <div id="cart-step-2" class="hidden flex-col h-full">
        ...
        <div class="flex-grow overflow-y-auto p-4 sm:p-5 space-y-4">
            ...
            <div class="space-y-3.5 bg-gray-50 p-4 rounded-2xl border border-gray-200">
                ...
                <!-- Dirección de entrega & Pin en Mapa (Diseño Limpio y Profesional) -->
                <div id="delivery-address-container" class="space-y-3">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div id="address-autocomplete-dropdown" class="hidden absolute top-full left-0 right-0 z-50 mt-1 bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden divide-y divide-gray-100 max-h-52 overflow-y-auto">
                                <!-- Se rellena dinámicamente al escribir -->
                            </div>
                        </div>
                    </div>

                    <!-- Contenedor del Mapa Interactivo (Limpio y directo) -->
                    <div class="bg-white rounded-2xl border border-gray-200 p-2.5 sm:p-3 space-y-2 shadow-xs">
                        <div class="flex items-center justify-between px-0.5">
                            <div class="flex items-center space-x-1.5">
                                <i class="fas fa-map-marker-alt text-red-600 text-xs"></i>
                                <span class="text-xs font-bold text-gray-800">Punto de entrega</span>
                            </div>
                            <span id="cart-map-status-text" class="text-[11px] font-semibold text-gray-500">
                                Escribe tu calle o toca el mapa
                            </span>
                        </div>

                        <!-- Canvas del Mapa -->
                        <div class="relative w-full h-44 sm:h-52 rounded-xl overflow-hidden border border-gray-200 shadow-inner bg-gray-100">
                            <div id="cart-leaflet-map" class="w-full h-full z-10"></div>
                            
                            <div class="absolute bottom-2 left-2 right-2 z-20 pointer-events-none">
                                <div class="bg-slate-900/80 backdrop-blur-xs text-white px-2.5 py-1 rounded-lg text-[10px] text-center font-medium shadow-md">
                                    👉 Toca el mapa o arrastra el pin para afinar tu puerta exacta
                                </div>
                            </div>
                        </div>
                    </div>
