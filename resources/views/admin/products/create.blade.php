        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" id="product-form" class="space-y-6">
                ...
                <div class="bg-amber-50/60 border border-amber-200/70 rounded-2xl p-4 space-y-3">
                    ...
                    <div id="cooking-options-details" class="{{ old('has_cooking_options') ? '' : 'hidden' }} pt-2 border-t border-amber-200/60 flex flex-wrap gap-4 items-center">
                        ...
                        <label class="inline-flex items-center space-x-2 text-xs font-bold text-slate-700 bg-white px-3 py-1.5 rounded-xl border border-amber-200 shadow-2xs">
                            <input type="checkbox" name="cooking_options[]" value="Horno" checked class="text-amber-600 rounded focus:ring-amber-500">
                            <span>🔥 Horno</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 text-xs font-bold text-slate-700 bg-white px-3 py-1.5 rounded-xl border border-amber-200 shadow-2xs">
            ...
            <div class="border-t border-slate-100 pt-6 space-y-4">
                ...
                <div class="bg-emerald-50/60 border border-emerald-200/70 rounded-2xl p-4 sm:p-5 space-y-4">
                    <label class="flex items-center space-x-3 cursor-pointer">
                        <input type="checkbox" name="has_garnishes" id="has_garnishes" value="1" {{ old('has_garnishes') ? 'checked' : '' }}
                    ...
                    <div id="garnishes-section-details" class="{{ old('has_garnishes') ? '' : 'hidden' }} pt-3 border-t border-emerald-200/60 space-y-3">
                        <div class="flex items-center justify-between">
    ...
    function addGarnishRow(name = '', price = '0', desc = '', image = '') {
        ...
        row.innerHTML = `
            ...
            <div class="flex items-center space-x-3 flex-shrink-0">
                ...
                <input type="hidden" name="garnish_existing_images[]" class="garnish-existing-input" value="${image || ''}">
            </div>
